...
<div class="row"><nav class="navbar navbar-default col-md-12">
  ...
  <a href="#" class="btn btn-lg btn-info"><span class="glyphicon glyphicon-tag"></span> Type</a>
  <a href="#" class="btn btn-lg btn-info"><span class="glyphicon glyphicon-tags"></span> Structure</a>
  <a href="#" class="btn btn-lg btn-success"><span class="glyphicon glyphicon-heart"></span> Favoris</a>
  <a href="#" class="btn btn-lg btn-warning"><span class="glyphicon glyphicon-warning-sign"></span> Obsolètes</a>
